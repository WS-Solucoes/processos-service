...
public enum AcaoProcesso {
    ...
    MENSAGEM_SUPERIOR("Mensagem do superior"),
    SOLICITADO_COMPLEMENTO("Complementação solicitada"),
    ATRIBUIDO("Processo atribuído"),
    EM_ANALISE("Em análise"),
    ETAPA_AVANCADA("Etapa avançada"),
    ENCAMINHADO_SUPERIOR("Encaminhado para superior"),
    APROVADO_SUPERIOR("Aprovado pelo superior"),
    REPROVADO_SUPERIOR("Reprovado pelo superior"),
